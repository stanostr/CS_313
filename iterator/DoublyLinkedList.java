...
public class DoublyLinkedList<E> implements Iterable<E>{
    ...
    //note that header and trailer are dummy variables that hold no data
    //but make it easier to perform operations at the start and end of list.
    ...
    private class LinkedListIterator implements Iterator<E>
    {
        ...
        public E next() throws NoSuchElementException {
            if(current.next == trailer) throw new NoSuchElementException("No next element");
            removable = true;
